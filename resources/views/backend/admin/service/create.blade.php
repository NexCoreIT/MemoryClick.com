        ...
        <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Upload a high-quality image (JPEG, PNG). <br>
                        @error('image')
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" name="youtube_link" placeholder="Enter YouTube video URL"    >
                    @error('youtube_link')
                        <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <div id="steps-container">
                    ...
                    <div class="step-input mb-2 d-flex align-items-center gap-2">
                        <input type="text" class="form-control" name="steps[]" placeholder="Enter step description">
