                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        ...
                        @if($property->before_image)
                            <img src="{{ asset('public/'.$property->before_image) }}" class="img-fluid img-thumbnail" alt="Before Image">
                        @else
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        @if($property->after_image)
                            <img src="{{ asset('public/'.$property->after_image) }}" class="img-fluid img-thumbnail" alt="After Image">
                        @else
                            <p class="text-muted">No image available</p>
                        @endif
                    </div>
