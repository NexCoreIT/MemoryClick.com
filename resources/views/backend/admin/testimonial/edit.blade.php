        ...
        <form action="{{ route('testimonial.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" name="designation" value="{{ old('name', $testimonial->designation) }}" class="form-control @error('designation') is-invalid @enderror" placeholder="Customer Designation" required>
                    @error('designation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
