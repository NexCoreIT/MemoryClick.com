            ...
            <div class="card-body table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('cinematographies.edit', $item->id) }}" class="btn btn-sm btn-warning">Edit</a>
                            <form action="{{ route('cinematographies.delete', $item->id) }}" method="POST" class="d-inline">
                                @csrf @method('DELETE')
